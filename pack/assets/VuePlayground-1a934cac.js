import { r, v, C, a as __vitePreload } from "./app-fa9793f0.js";
  ...
  setup(e) {
    const i = r(), r$1 = ref(true), a = shallowRef(), l = shallowRef(), u = shallowRef(), o = computed(() => v({}, i, R(e.settings))), s = async () => {
      const [{
        ...
        default: v2
      }] = await Promise.all([__vitePreload(() => import("./vue-repl-c6248f5d.js"), true ? ["assets/vue-repl-c6248f5d.js","assets/app-fa9793f0.js","assets/utils-a5e1dbae-d385d065.js"] : void 0), __vitePreload(() => import("./codemirror-editor-d333453a.js"), true ? ["assets/codemirror-editor-d333453a.js","assets/utils-a5e1dbae-d385d065.js"] : void 0)]);
