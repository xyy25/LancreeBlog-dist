import { c as getConfig$1, g as getAccTitle, s as setAccTitle, a as getAccDescription, b as setAccDescription, x as setDiagramTitle, y as getDiagramTitle, m as mermaidAPI, l as log$1, j as common$1, A as clear$1, b2 as generateId } from "./mermaid.core-62ee9cf6.js";
var parser = function() {
...
const addState = function(id, type = DEFAULT_STATE_TYPE, doc = null, descr = null, note = null, classes2 = null, styles2 = null, textStyles = null) {
  ...
  if (note) {
    ...
    currentDocument.states[trimmedId].note.text = common$1.sanitizeText(currentDocument.states[trimmedId].note.text, getConfig$1());
  }
  if (classes2) {
