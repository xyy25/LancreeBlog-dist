 ...
 */
const x = window, Q = x.ShadowRoot && (x.ShadyCSS === void 0 || x.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Z = Symbol(), X = /* @__PURE__ */ new WeakMap();
let dt = class {
  constructor(t, e, s) {
...
const gt = (i) => new dt(typeof i == "string" ? i : i + "", void 0, Z), ft = (i, ...t) => {
 ...
 */
var D;
const H = window, et = H.trustedTypes, At = et ? et.emptyScript : "", st = H.reactiveElementPolyfillSupport, q = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? At : null;
      break;
  ...
  return e;
} }, ut = (i, t) => t !== i && (t == t || i == i), z = { attribute: true, type: String, converter: q, reflect: false, hasChanged: ut }, J = "finalized";
 ...
 */
var j;
const k = window, E = k.trustedTypes, it = E ? E.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, F = "$lit$", f = `lit$${(Math.random() + "").slice(9)}$`, pt = "?" + f, yt = `<${pt}>`, y = document, O = () => y.createComment(""), P = (i) => i === null || typeof i != "object" && typeof i != "function", $t = Array.isArray, St = (i) => $t(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", B = `[ 	
\f\r]`, w = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, nt = /-->/g, rt = />/g, m = RegExp(`>|${B}(?:([^\\s"'>=/]+)(${B}*=${B}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ot = /'/g, lt = /"/g, _t = /^(?:script|style|textarea|title)$/i, Et = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), bt = Et(1), b = Symbol.for("lit-noChange"), u = Symbol.for("lit-nothing"), ht = /* @__PURE__ */ new WeakMap(), A = y.createTreeWalker(y, 129, null, false), Ct = (i, t) => {
...
class T {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    if (this.el = T.createElement(h, s), A.currentNode = this.el.content, e === 2) {
...
class R {
  ...
  T(t) {
    ...
    let s, n = 0;
    for (const r of t)
      n === e.length ? e.push(s = new R(this.k(O()), this.k(O()), this, this.options)) : s = e[n], s._$AI(r), n++;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const kt = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, Lt = (i) => (...t) => ({ _$litDirective$: i, values: t });
let Gt = class {
  constructor(t) {
  }
  get _$AU() {
...
const Y = /* @__PURE__ */ new WeakMap(), Kt = Lt(class extends Bt {
  render(i) {
    return u;
  }
  update(i, [t]) {
...
var Yt = Object.defineProperty, qt = Object.getOwnPropertyDescriptor, $ = (i, t, e, s) => {
...
let p = class extends U {
  ...
  setupSession() {
    ...
    if (e)
      try {
        ...
        localStorage.removeItem(this.GISCUS_SESSION_KEY), void 0;
      }
  }
  signOut() {
  ...
  sendMessage(i) {
    !this.iframeRef || !this.iframeRef.contentWindow || !this.hasLoaded || (void 0, this.iframeRef.contentWindow.postMessage({ giscus: i }, this._host));
  }
  updateConfig() {
    const i = {
      setConfig: {
