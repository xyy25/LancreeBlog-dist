import { h as defineComponent, i as r, j as ref, k as shallowRef, l as computed, v, m as onMounted, n as h, C, p as __vitePreload } from "./app-66d4b327.js";
const style = "";
const vuePlayground = "";
  ...
  setup(e) {
    const i = r(), r$1 = ref(true), a = shallowRef(), l = shallowRef(), u = shallowRef(), o = computed(() => v({}, i, R(e.settings))), s = async () => {
      const [{
        ...
        default: v2
      }] = await Promise.all([__vitePreload(() => import("./vue-repl-8724e248.js"), true ? ["assets/vue-repl-8724e248.js","assets/app-66d4b327.js","assets/utils-a5e1dbae-d385d065.js"] : void 0), __vitePreload(() => import("./codemirror-editor-a2aa6b4a.js"), true ? ["assets/codemirror-editor-a2aa6b4a.js","assets/app-66d4b327.js","assets/utils-a5e1dbae-d385d065.js"] : void 0)]);
