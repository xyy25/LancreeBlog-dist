import { B as isObjectLike, C as baseGetTag, S as Symbol$1, D as isArray, E as isObject, F as isArrayLike, G as arrayLikeKeys, H as baseKeys, I as memoize, J as isArguments, K as setToString, L as overRest, M as copyObject, N as keysIn, O as getPrototype, P as cloneArrayBuffer, Q as cloneTypedArray, R as getTag, T as nodeUtil, U as baseUnary, V as copyArray, W as isBuffer, X as cloneBuffer, Y as initCloneObject, Z as Stack, _ as assignValue, $ as MapCache, a0 as eq, a1 as Uint8Array, a2 as isTypedArray, a3 as isLength, a4 as isIndex, a5 as identity, a6 as baseFor, a7 as root, a8 as baseRest, a9 as isIterateeCall, aa as baseAssignValue, ab as Set, ac as isArrayLikeObject, ad as constant, ae as isFunction, af as isEmpty, ag as merge } from "./mermaid.core-62ee9cf6.js";
...
function longestPath(g) {
  ...
  function dfs2(v) {
    ...
    visited[v] = true;
    var rank2 = min(map(g.outEdges(v), function(e) {
...
function twoLayerCrossCount(g, northLayer, southLayer) {
  ...
  var southEntries = flatten(map(northLayer, function(v) {
    return sortBy$1(map(g.outEdges(v), function(e) {
      return {
        pos: southPos[e.w],
...
function initOrder(g) {
  ...
  var maxRank2 = max(map(simpleNodes, function(v) {
    return g.node(v).rank;
  }));
...
function doResolveConflicts(sourceSet) {
  ...
  return map(filter(entries, function(entry2) {
...
function buildLayoutGraph(inputGraph) {
  ...
  g.setGraph(merge({}, graphDefaults, selectNumberAttrs(graph, graphNumAttrs), pick$1(graph, graphAttrs)));
  forEach(inputGraph.nodes(), function(v) {
  ...
  forEach(inputGraph.edges(), function(e) {
    ...
    g.setEdge(e, merge({}, edgeDefaults, selectNumberAttrs(edge, edgeNumAttrs), pick$1(edge, edgeAttrs)));
  });
  return g;
}
