import { h as defineComponent, i as r, j as ref, k as shallowRef, l as computed, v, m as onMounted, n as h, C, p as __vitePreload } from "./app-998d8359.js";
const style = "";
const vuePlayground = "";
...
var S = defineComponent({ name: "VuePlayground", props: { title: { type: String, default: "" }, files: { type: String, required: true }, settings: { type: String, default: "{}" } }, setup(e) {
  const i = r(), r$1 = ref(true), a = shallowRef(), l = shallowRef(), u = shallowRef(), o = computed(() => v({}, i, R(e.settings))), s = async () => {
    const [{ ReplStore: d, Repl: p }, { default: v2 }] = await Promise.all([__vitePreload(() => import("./vue-repl-61447398.js"), true ? ["assets/vue-repl-61447398.js","assets/app-998d8359.js","assets/commonjs-dynamic-modules-58f2b0ec.js","assets/utils-a5e1dbae-0ece3425.js"] : void 0), __vitePreload(() => import("./codemirror-editor-f804921b.js"), true ? ["assets/codemirror-editor-f804921b.js","assets/app-998d8359.js","assets/utils-a5e1dbae-0ece3425.js"] : void 0)]);
