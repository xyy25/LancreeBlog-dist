import { r, v, C, a as __vitePreload } from "./app-b24c98cd.js";
  ...
  setup(e) {
    const i = r(), r$1 = ref(true), a = shallowRef(), l = shallowRef(), u = shallowRef(), o = computed(() => v({}, i, R(e.settings))), s = async () => {
      const [{
        ...
        default: v2
      }] = await Promise.all([__vitePreload(() => import("./vue-repl-2f99d569.js"), true ? ["assets/vue-repl-2f99d569.js","assets/app-b24c98cd.js","assets/utils-a5e1dbae-d385d065.js"] : void 0), __vitePreload(() => import("./codemirror-editor-d333453a.js"), true ? ["assets/codemirror-editor-d333453a.js","assets/utils-a5e1dbae-d385d065.js"] : void 0)]);
