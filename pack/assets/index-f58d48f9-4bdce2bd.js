import { b as baseClone, i as isUndefined, m as map, G as Graph, l as layout } from "./layout-acb8b390.js";
import { i as insertMarkers$1, u as updateNodeBounds, s as setNodeElem, a as insertNode, b as insertEdgeLabel, p as positionNode, c as insertEdge, d as positionEdgeLabel, e as clear$1$1, f as clear$2, g as createLabel$1, h as intersectRect$1 } from "./edges-0005682e-9145f043.js";
import { l as log$1, r as evaluate, c as getConfig$1, h as select } from "./mermaid.core-637cfb92.js";
      ...
      edges.forEach((edge) => {
        ...
        try {
          if (edgeInCluster(edge, rootId)) {
            ...
            log$1.info("Skipping copy of edge ", edge.v, "-->", edge.w, " rootId: ", rootId, " clusterId:", clusterId);
          }
        } catch (e) {
          log$1.error(e);
        }
...
const roundedWithTitle = (parent, node) => {
  ...
  label.attr("transform", "translate(" + (node.x - bbox.width / 2) + ", " + (node.y - node.height / 2 - node.padding / 3 + (evaluate(getConfig$1().flowchart.htmlLabels) ? 5 : 3)) + ")");
  const rectBox = rect2.node().getBBox();
  node.height = rectBox.height;
  node.intersect = function(point) {
    return intersectRect$1(node, point);
