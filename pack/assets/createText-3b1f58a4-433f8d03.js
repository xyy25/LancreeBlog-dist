import { l as log$1, ao as decodeEntities, aq as dedent } from "./mermaid.core-637cfb92.js";
const emptyOptions = {};
...
const createText = (el, text2 = "", {
  ...
  if (useHtmlLabels) {
    ...
    const node2 = {
      isNode,
      label: decodeEntities(htmlText2).replace(/fa[blrs]?:fa-[\w-]+/g, (s) => `<i class='${s.replace(":", " ")}'></i>`),
