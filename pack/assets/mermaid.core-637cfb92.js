import { q as commonjsGlobal, t as getDefaultExportFromCjs, u as purify, p as __vitePreload } from "./app-d0296eec.js";
...
const mkBorder = (col, darkMode) => darkMode ? adjust$1(col, {
  s: -40,
  l: 10
}) : adjust$1(col, {
  s: -40,
...
let Theme$4 = class Theme {
  ...
  updateColors() {
    ...
    this.secondaryColor = this.secondaryColor || adjust$1(this.primaryColor, {
      h: -120
    });
    this.tertiaryColor = this.tertiaryColor || adjust$1(this.primaryColor, {
      h: 180,
      l: 5
    });
    ...
    this.cScale3 = this.cScale3 || adjust$1(this.primaryColor, {
      h: 30
    });
    this.cScale4 = this.cScale4 || adjust$1(this.primaryColor, {
      h: 60
    });
    this.cScale5 = this.cScale5 || adjust$1(this.primaryColor, {
      h: 90
    });
    this.cScale6 = this.cScale6 || adjust$1(this.primaryColor, {
      h: 120
    });
    this.cScale7 = this.cScale7 || adjust$1(this.primaryColor, {
      h: 150
    });
    this.cScale8 = this.cScale8 || adjust$1(this.primaryColor, {
      h: 210,
      l: 150
    });
    this.cScale9 = this.cScale9 || adjust$1(this.primaryColor, {
      h: 270
    });
    this.cScale10 = this.cScale10 || adjust$1(this.primaryColor, {
      h: 300
    });
    this.cScale11 = this.cScale11 || adjust$1(this.primaryColor, {
      h: 330
    });
    if (this.darkMode) {
    ...
    for (let i = 0; i < 5; i++) {
      this["surface" + i] = this["surface" + i] || adjust$1(this.mainBkg, {
        h: 180,
        s: -15,
        l: multiplier * (5 + i * 3)
      });
      this["surfacePeer" + i] = this["surfacePeer" + i] || adjust$1(this.mainBkg, {
        h: 180,
        s: -15,
        l: multiplier * (8 + i * 3)
      });
    ...
    this.fillType2 = this.fillType2 || adjust$1(this.primaryColor, {
      h: 64
    });
    this.fillType3 = this.fillType3 || adjust$1(this.secondaryColor, {
      h: 64
    });
    this.fillType4 = this.fillType4 || adjust$1(this.primaryColor, {
      h: -64
    });
    this.fillType5 = this.fillType5 || adjust$1(this.secondaryColor, {
      h: -64
    });
    this.fillType6 = this.fillType6 || adjust$1(this.primaryColor, {
      h: 128
    });
    this.fillType7 = this.fillType7 || adjust$1(this.secondaryColor, {
      h: 128
    });
    this.pie1 = this.pie1 || this.primaryColor;
    this.pie2 = this.pie2 || this.secondaryColor;
    this.pie3 = this.pie3 || this.tertiaryColor;
    this.pie4 = this.pie4 || adjust$1(this.primaryColor, {
      l: -10
    });
    this.pie5 = this.pie5 || adjust$1(this.secondaryColor, {
      l: -10
    });
    this.pie6 = this.pie6 || adjust$1(this.tertiaryColor, {
      l: -10
    });
    this.pie7 = this.pie7 || adjust$1(this.primaryColor, {
      h: 60,
      l: -10
    });
    this.pie8 = this.pie8 || adjust$1(this.primaryColor, {
      h: -60,
      l: -10
    });
    this.pie9 = this.pie9 || adjust$1(this.primaryColor, {
      h: 120,
      l: 0
    });
    this.pie10 = this.pie10 || adjust$1(this.primaryColor, {
      h: 60,
      l: -20
    });
    this.pie11 = this.pie11 || adjust$1(this.primaryColor, {
      h: -60,
      l: -20
    });
    this.pie12 = this.pie12 || adjust$1(this.primaryColor, {
      h: 120,
      l: -10
    });
    ...
    this.quadrant2Fill = this.quadrant2Fill || adjust$1(this.primaryColor, {
      r: 5,
      g: 5,
      b: 5
    });
    this.quadrant3Fill = this.quadrant3Fill || adjust$1(this.primaryColor, {
      r: 10,
      g: 10,
      b: 10
    });
    this.quadrant4Fill = this.quadrant4Fill || adjust$1(this.primaryColor, {
      r: 15,
      g: 15,
      b: 15
    });
    this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor;
    this.quadrant2TextFill = this.quadrant2TextFill || adjust$1(this.primaryTextColor, {
      r: -5,
      g: -5,
      b: -5
    });
    this.quadrant3TextFill = this.quadrant3TextFill || adjust$1(this.primaryTextColor, {
      r: -10,
      g: -10,
      b: -10
    });
    this.quadrant4TextFill = this.quadrant4TextFill || adjust$1(this.primaryTextColor, {
      r: -15,
      g: -15,
      b: -15
    });
    ...
    this.git3 = this.git3 || adjust$1(this.primaryColor, {
      h: -30
    });
    this.git4 = this.git4 || adjust$1(this.primaryColor, {
      h: -60
    });
    this.git5 = this.git5 || adjust$1(this.primaryColor, {
      h: -90
    });
    this.git6 = this.git6 || adjust$1(this.primaryColor, {
      h: 60
    });
    this.git7 = this.git7 || adjust$1(this.primaryColor, {
      h: 120
    });
    if (this.darkMode) {
...
let Theme$3 = class Theme2 {
  constructor() {
    ...
    this.tertiaryColor = adjust$1(this.primaryColor, {
      h: -160
    });
  ...
  updateColors() {
    ...
    this.fillType2 = adjust$1(this.primaryColor, {
      h: 64
    });
    this.fillType3 = adjust$1(this.secondaryColor, {
      h: 64
    });
    this.fillType4 = adjust$1(this.primaryColor, {
      h: -64
    });
    this.fillType5 = adjust$1(this.secondaryColor, {
      h: -64
    });
    this.fillType6 = adjust$1(this.primaryColor, {
      h: 128
    });
    this.fillType7 = adjust$1(this.secondaryColor, {
      h: 128
    });
    ...
    this.git3 = lighten$1(this.pie4 || adjust$1(this.primaryColor, {
      h: -30
    }), 20);
    this.git4 = lighten$1(this.pie5 || adjust$1(this.primaryColor, {
      h: -60
    }), 20);
    this.git5 = lighten$1(this.pie6 || adjust$1(this.primaryColor, {
      h: -90
    }), 10);
    this.git6 = lighten$1(this.pie7 || adjust$1(this.primaryColor, {
      h: 60
    }), 10);
    this.git7 = lighten$1(this.pie8 || adjust$1(this.primaryColor, {
      h: 120
    }), 20);
    this.gitInv0 = this.gitInv0 || invert$1(this.git0);
    this.gitInv1 = this.gitInv1 || invert$1(this.git1);
...
let Theme$2 = class Theme3 {
  constructor() {
    ...
    this.secondaryColor = adjust$1(this.primaryColor, {
      h: 120
    });
  ...
  updateColors() {
    ...
    for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) {
      this["cScaleInv" + i] = this["cScaleInv" + i] || adjust$1(this["cScale" + i], {
        h: 180
      });
    }
    for (let i = 0; i < 5; i++) {
    ...
    this.pie1 = this.pie1 || this.primaryColor;
    this.pie2 = this.pie2 || this.secondaryColor;
    this.pie3 = this.pie3 || adjust$1(this.tertiaryColor, {
      l: -40
    });
    this.pie4 = this.pie4 || adjust$1(this.primaryColor, {
      l: -10
...
class Theme5 {
  ...
  updateColors() {
    ...
    this.git3 = this.pie4 || adjust$1(this.primaryColor, {
      h: -30
    });
    this.git4 = this.pie5 || adjust$1(this.primaryColor, {
      h: -60
    });
    this.git5 = this.pie6 || adjust$1(this.primaryColor, {
      h: -90
    });
    this.git6 = this.pie7 || adjust$1(this.primaryColor, {
      h: 60
    });
    this.git7 = this.pie8 || adjust$1(this.primaryColor, {
      h: 120
    });
    this.gitInv0 = this.gitInv0 || invert$1(this.git0);
    this.gitInv1 = this.gitInv1 || invert$1(this.git1);
...
`, "ig");
    ...
    log$1.error(`ERROR: ${error.message} - Unable to parse directive
  ...
  words.forEach((word, index) => {
    ...
    if (wordLength > maxWidth) {
      const {
        hyphenatedStrings,
        remainingWord
      } = breakString(word, maxWidth, "-", config2);
...
const calculateTextDimensions = memoize((text, config2) => {
  config2 = Object.assign({
    fontSize: 12,
    fontWeight: 400,
    fontFamily: "Arial"
...
const loader$k = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./c4Diagram-c0b17d02-645abce3.js"), true ? ["assets/c4Diagram-c0b17d02-645abce3.js","assets/svgDrawCommon-42e92da3-aa71a658.js","assets/app-d0296eec.js"] : void 0);
  return {
    id: id$j,
    diagram: diagram2
  };
...
const loader$j = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./flowDiagram-d6f8fe3a-df1c8fba.js"), true ? ["assets/flowDiagram-d6f8fe3a-df1c8fba.js","assets/flowDb-ff651a22-db0510b4.js","assets/layout-acb8b390.js","assets/styles-1b0c237a-6e260ccd.js","assets/index-f58d48f9-4bdce2bd.js","assets/edges-0005682e-9145f043.js","assets/createText-3b1f58a4-433f8d03.js","assets/svgDraw-70101091-7b39b26d.js","assets/line-c4839123.js","assets/array-b7dcf730.js","assets/path-39bad7e2.js","assets/app-d0296eec.js"] : void 0);
  return {
    id: id$i,
    diagram: diagram2
  };
...
const loader$i = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./flowDiagram-v2-58f49b84-2145cdaa.js"), true ? ["assets/flowDiagram-v2-58f49b84-2145cdaa.js","assets/flowDb-ff651a22-db0510b4.js","assets/styles-1b0c237a-6e260ccd.js","assets/layout-acb8b390.js","assets/index-f58d48f9-4bdce2bd.js","assets/edges-0005682e-9145f043.js","assets/createText-3b1f58a4-433f8d03.js","assets/svgDraw-70101091-7b39b26d.js","assets/line-c4839123.js","assets/array-b7dcf730.js","assets/path-39bad7e2.js","assets/app-d0296eec.js"] : void 0);
  return {
    id: id$h,
    diagram: diagram2
  };
...
const loader$h = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./erDiagram-dedf2781-a6c43b9c.js"), true ? ["assets/erDiagram-dedf2781-a6c43b9c.js","assets/layout-acb8b390.js","assets/app-d0296eec.js","assets/line-c4839123.js","assets/array-b7dcf730.js","assets/path-39bad7e2.js"] : void 0);
  return {
    id: id$g,
    diagram: diagram2
  };
...
const loader$g = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./gitGraphDiagram-e0ffc2d1-07c477a3.js"), true ? ["assets/gitGraphDiagram-e0ffc2d1-07c477a3.js","assets/app-d0296eec.js"] : void 0);
  return {
    id: id$f,
    diagram: diagram2
  };
...
const loader$f = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./ganttDiagram-088dbd90-ef8d4aeb.js"), true ? ["assets/ganttDiagram-088dbd90-ef8d4aeb.js","assets/app-d0296eec.js","assets/linear-7754f870.js","assets/init-cc95ec8e.js"] : void 0);
  return {
    id: id$e,
    diagram: diagram2
  };
...
const loader$e = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./infoDiagram-64895a6e-5f836e82.js"), true ? ["assets/infoDiagram-64895a6e-5f836e82.js","assets/app-d0296eec.js"] : void 0);
  return {
    id: id$d,
    diagram: diagram2
  };
...
const loader$d = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./pieDiagram-3fca7ce7-4e4a4700.js"), true ? ["assets/pieDiagram-3fca7ce7-4e4a4700.js","assets/app-d0296eec.js","assets/arc-8280539f.js","assets/path-39bad7e2.js","assets/ordinal-fcef8353.js","assets/init-cc95ec8e.js","assets/array-b7dcf730.js"] : void 0);
  return {
    id: id$c,
    diagram: diagram2
  };
...
const loader$c = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./quadrantDiagram-0ca4be02-8c3ee9fb.js"), true ? ["assets/quadrantDiagram-0ca4be02-8c3ee9fb.js","assets/app-d0296eec.js","assets/linear-7754f870.js","assets/init-cc95ec8e.js"] : void 0);
  return {
    id: id$b,
    diagram: diagram2
  };
...
const loader$b = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./requirementDiagram-e13af0f0-93fa7be4.js"), true ? ["assets/requirementDiagram-e13af0f0-93fa7be4.js","assets/layout-acb8b390.js","assets/app-d0296eec.js","assets/line-c4839123.js","assets/array-b7dcf730.js","assets/path-39bad7e2.js"] : void 0);
  return {
    id: id$a,
    diagram: diagram2
  };
...
const loader$a = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./sequenceDiagram-84aa38e3-695db72d.js"), true ? ["assets/sequenceDiagram-84aa38e3-695db72d.js","assets/svgDrawCommon-42e92da3-aa71a658.js","assets/app-d0296eec.js"] : void 0);
  return {
    id: id$9,
    diagram: diagram2
  };
...
const loader$9 = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./classDiagram-a8cc8886-370df192.js"), true ? ["assets/classDiagram-a8cc8886-370df192.js","assets/styles-622362e4-ee3b5634.js","assets/layout-acb8b390.js","assets/svgDraw-70101091-7b39b26d.js","assets/line-c4839123.js","assets/array-b7dcf730.js","assets/path-39bad7e2.js","assets/app-d0296eec.js"] : void 0);
  return {
    id: id$8,
    diagram: diagram2
  };
...
const loader$8 = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./classDiagram-v2-802a48d3-6758b2b1.js"), true ? ["assets/classDiagram-v2-802a48d3-6758b2b1.js","assets/styles-622362e4-ee3b5634.js","assets/layout-acb8b390.js","assets/index-f58d48f9-4bdce2bd.js","assets/edges-0005682e-9145f043.js","assets/createText-3b1f58a4-433f8d03.js","assets/svgDraw-70101091-7b39b26d.js","assets/line-c4839123.js","assets/array-b7dcf730.js","assets/path-39bad7e2.js","assets/app-d0296eec.js"] : void 0);
  return {
    id: id$7,
    diagram: diagram2
  };
...
const loader$7 = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./stateDiagram-9a586ac6-78babf2a.js"), true ? ["assets/stateDiagram-9a586ac6-78babf2a.js","assets/styles-a1a6e33f-240109d8.js","assets/layout-acb8b390.js","assets/app-d0296eec.js","assets/line-c4839123.js","assets/array-b7dcf730.js","assets/path-39bad7e2.js"] : void 0);
  return {
    id: id$6,
    diagram: diagram2
  };
...
const loader$6 = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./stateDiagram-v2-96f2b9df-22f5cf69.js"), true ? ["assets/stateDiagram-v2-96f2b9df-22f5cf69.js","assets/styles-a1a6e33f-240109d8.js","assets/layout-acb8b390.js","assets/index-f58d48f9-4bdce2bd.js","assets/edges-0005682e-9145f043.js","assets/createText-3b1f58a4-433f8d03.js","assets/svgDraw-70101091-7b39b26d.js","assets/line-c4839123.js","assets/array-b7dcf730.js","assets/path-39bad7e2.js","assets/app-d0296eec.js"] : void 0);
  return {
    id: id$5,
    diagram: diagram2
  };
...
const loader$5 = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./journeyDiagram-adaa34f8-12ec0505.js"), true ? ["assets/journeyDiagram-adaa34f8-12ec0505.js","assets/svgDrawCommon-42e92da3-aa71a658.js","assets/app-d0296eec.js","assets/arc-8280539f.js","assets/path-39bad7e2.js"] : void 0);
  return {
    id: id$4,
    diagram: diagram2
  };
...
const loader$4 = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./flowchart-elk-definition-56584a6c-5eb4e1ce.js"), true ? ["assets/flowchart-elk-definition-56584a6c-5eb4e1ce.js","assets/flowDb-ff651a22-db0510b4.js","assets/edges-0005682e-9145f043.js","assets/createText-3b1f58a4-433f8d03.js","assets/svgDraw-70101091-7b39b26d.js","assets/line-c4839123.js","assets/array-b7dcf730.js","assets/path-39bad7e2.js","assets/app-d0296eec.js"] : void 0);
  return {
    id: id$3,
    diagram: diagram2
  };
...
const loader$3 = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./timeline-definition-1a90b03d-44fe79a1.js"), true ? ["assets/timeline-definition-1a90b03d-44fe79a1.js","assets/app-d0296eec.js","assets/arc-8280539f.js","assets/path-39bad7e2.js"] : void 0);
  return {
    id: id$2,
    diagram: diagram2
  };
...
const loader$2 = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./mindmap-definition-57868176-b2413015.js"), true ? ["assets/mindmap-definition-57868176-b2413015.js","assets/createText-3b1f58a4-433f8d03.js","assets/app-d0296eec.js"] : void 0);
  return {
    id: id$1,
    diagram: diagram2
  };
...
const loader$1 = async () => {
  const {
    diagram: diagram2
  } = await __vitePreload(() => import("./sankeyDiagram-a7f8e230-b0ff3737.js"), true ? ["assets/sankeyDiagram-a7f8e230-b0ff3737.js","assets/app-d0296eec.js","assets/ordinal-fcef8353.js","assets/init-cc95ec8e.js"] : void 0);
  return {
    id,
    diagram: diagram2
  };
...
const parseDirective$1 = function(p, statement, context, type2) {
  ...
  try {
    ...
    log$1.error(`Error while rendering sequenceDiagram directive: ${statement} jison context: ${context}`);
...
const handleDirective = function(p, directive, type2) {
  ...
  switch (directive.type) {
    ...
    case "themeCss":
      ...
      break;
    default:
      log$1.warn(`Unhandled directive: source: '%%{${directive.type}: ${JSON.stringify(directive.args ? directive.args : {})}}%%`, directive);
      break;
  }
};
const log = log$1;
...
const registerDiagram = (id2, diagram2, detector2) => {
  ...
  if (diagram2.injectUtils) {
    diagram2.injectUtils(log, setLogLevel, getConfig, sanitizeText, setupGraphViewbox, getCommonDb(), parseDirective);
  }
};
...
const addDiagrams = () => {
  ...
  registerLazyLoadedDiagrams(c4, classDiagramV2, classDiagram, er, gantt, info, pie, requirement, sequence, flowchartElk, flowchartV2, flowchart, mindmap, timeline, git, stateV2, state, journey, quadrantChart, sankey);
};
...
function makeSnippet(mark, options) {
  ...
  for (i = 1; i <= options.linesBefore; i++) {
    if (foundLineNo - i < 0)
      break;
    line2 = getLine(mark.buffer, lineStarts[foundLineNo - i], lineEnds[foundLineNo - i], mark.position - (lineStarts[foundLineNo] - lineStarts[foundLineNo - i]), maxLineLength);
...
const CLASSDEF_DIAGRAMS = ["graph", "flowchart", "flowchart-v2", "flowchart-elk", "stateDiagram", "stateDiagram-v2"];
...
export {
  ...
  keysIn as N,
  getPrototype$1 as O,
  cloneArrayBuffer as P,
  cloneTypedArray as Q,
  getTag$1 as R,
  Symbol$2 as S,
  nodeUtil$1 as T,
  baseUnary as U,
  ...
  tau as aK,
  defaultConfig$1 as aL,
  parseDirective$1 as aM,
  cleanAndMerge as aN,
  parseFontSize as aO,
  pi as aP,
  cos as aQ,
  ...
  lineBreakRegex as o,
  curveLinear as p,
  getStylesFromArray as q,
  evaluate as r,
  setAccTitle as s,
  interpolateToCurve as t,
  setupGraphViewbox$1 as u,
  defaultConfig as v,
  wrapLabel as w,
  setDiagramTitle as x,
  getDiagramTitle as y,
  utils as z
};
