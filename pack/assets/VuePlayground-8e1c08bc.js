import { h as defineComponent, i as r, j as ref, k as shallowRef, l as computed, v, m as onMounted, n as h, C, p as __vitePreload } from "./app-5d65d1f1.js";
const style = "";
const vuePlayground = "";
...
var S = defineComponent({ name: "VuePlayground", props: { title: { type: String, default: "" }, files: { type: String, required: true }, settings: { type: String, default: "{}" } }, setup(e) {
  const i = r(), r$1 = ref(true), a = shallowRef(), l = shallowRef(), u = shallowRef(), o = computed(() => v({}, i, R(e.settings))), s = async () => {
    const [{ ReplStore: d, Repl: p }, { default: v2 }] = await Promise.all([__vitePreload(() => import("./vue-repl-c8000176.js"), true ? ["assets/vue-repl-c8000176.js","assets/app-5d65d1f1.js","assets/commonjs-dynamic-modules-58f2b0ec.js","assets/utils-a5e1dbae-0ece3425.js"] : void 0), __vitePreload(() => import("./codemirror-editor-8e4f56bf.js"), true ? ["assets/codemirror-editor-8e4f56bf.js","assets/app-5d65d1f1.js","assets/utils-a5e1dbae-0ece3425.js"] : void 0)]);
