import { h as defineComponent, i as r, j as ref, k as shallowRef, l as computed, v, m as onMounted, n as h, C, p as __vitePreload } from "./app-117e4cd6.js";
const style = "";
const vuePlayground = "";
...
var S = defineComponent({ name: "VuePlayground", props: { title: { type: String, default: "" }, files: { type: String, required: true }, settings: { type: String, default: "{}" } }, setup(e) {
  const i = r(), r$1 = ref(true), a = shallowRef(), l = shallowRef(), u = shallowRef(), o = computed(() => v({}, i, R(e.settings))), s = async () => {
    const [{ ReplStore: d, Repl: p }, { default: v2 }] = await Promise.all([__vitePreload(() => import("./vue-repl-dee2f9cd.js"), true ? ["assets/vue-repl-dee2f9cd.js","assets/app-117e4cd6.js","assets/commonjs-dynamic-modules-58f2b0ec.js","assets/commonjsHelpers-ca272635.js","assets/utils-a5e1dbae-0ece3425.js"] : void 0), __vitePreload(() => import("./codemirror-editor-ba5a8778.js"), true ? ["assets/codemirror-editor-ba5a8778.js","assets/app-117e4cd6.js","assets/utils-a5e1dbae-0ece3425.js"] : void 0)]);
